    ...
    <style>
        ...
        * {
        ...
        h1 {
            ...
            position: relative;
            left: 250px;
            background-color: rgb(134, 165, 219);
        }
...
<body>
    ...
    <h1 style="margin:20px;">Fill your details</h1>
    ...
    <div class="container">
        ...
        <form action="mailto:shubhashu620@gmail.com">
            ...
            <input type="text" id="lname" name="lname" placeholder="Enter your phone no.">
      ...
      <option value="usa">USA</option>
            ...
            <label for="subject">EXPLAIN UR DETAILS HERE </label>
